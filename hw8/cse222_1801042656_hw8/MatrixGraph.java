...
public class MatrixGraph extends AbstractGraph {
  ...
  /**
   * @param dummyValueForMatrixGraph just to understand it's a matrix graph.
   * @return edges in double array.
   */
  public double[][] getAllEdges(int dummyValueForMatrixGraph){
        return edges;
    }

    @Override
    public List<Edge>[] getAllEdges() {
        // Intentionally empty. This method is for list graph not matrix graph.
        return null;
    }
